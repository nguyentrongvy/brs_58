                                ...
                                <div class="tabbable-bordered">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab_general">
                                            {{ Form::open(['route' => ['book.update', $book->id], 'class' => 'js-validate-form', 'enctype' => 'multipart/form-data', 'method' => 'PUT']) }}
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        {{ Form::label('name', trans('lang.book.name'), ['class' => 'col-md-2 control-label']) }}
                                                        <div class="col-md-10">
                                                            {{ Form::text('name', old('name', $book->name), ['class' => 'form-control the-object-title']) }}
                                                            @if ($errors->has('name'))
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            {{ Form::text('slug', old('slug', $book->slug), ['class' => 'form-control the-object-slug']) }}
                                                            @if ($errors->has('slug'))
                                                                <span class="help-block">
                                                    ...
                                                    <div class="form-group" id="edit_image">
                                                        {{ Form::label('current-image', trans('lang.book.current-image'), ['class' => 'col-md-2 control-label']) }}
                                                        <img class="edit_image" src="{{ $book->image }}">
                                                    </div>

                                                    <div class="form-group">
                                                        {{ Form::label('author', trans('lang.book.author'), ['class' => 'col-md-2 control-label']) }}
                                                        <div class="col-md-10">
                                                            {{ Form::text('author', old('author', $book->author), ['class' => 'form-control the-object-title']) }}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            {{ Form::number('number_of_page', old('number_of_page', $book->number_of_page)) }}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            {{ Form::date('publish_date', old('publish_date', $book->publish_date)) }}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            {{ Form::text('title', old('title', $book->title), ['class' => 'form-control the-object-title']) }}
                                                            @if ($errors->has('title'))
                                                                <span class="help-block">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            {!! Form::textarea('description' , old('description', $book->description), ['class' => 'form-control']) !!}
                                                                ...
                                                                <div class="scroller"
                                                                    ...
                                                                    <ul class="list-unstyled">
                                                                        @foreach($nodes as $row)
                                                                            <li>
                                                                                <label><input type="checkbox" name="category_ids[]" value="{{ $row->id }}" {{ ((in_array($row->id, $checkedNodes)) ? 'checked="checked"' : '') }}>
                                                                                    {{ $row->name }}
                                                                                </label>
                                                                            </li>
                                                                        @endforeach
                                                ...
                                                {{ Form::submit(trans('lang.book.edit')) }}
                                            {{ Form::close() }}
                                        </div>
                                    </div>
                                </div>
